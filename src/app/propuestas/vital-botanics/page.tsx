  ...
  return (
    <SlideWrap active={active}>
      <div className="flex flex-col items-center text-center">
        ...
        <img
          src="/assets/vitalbotanics-logo.png"
          alt="Vital Botanics"
        ...
        <p className="anim mt-6 font-[family-name:var(--font-outfit)] text-lg font-light text-muted">
          Análisis preparado para Vital Botanics · Marzo 2026
        </p>
        {/* PULSR logo */}
...
function SlideGap({ active }: { active: boolean }) {
  const have = [
    "TikTok Shop activo con productos listados",
    "40+ suplementos en catálogo",
    "Contenido UGC y afiliados activos",
    "Presencia en Amazon MX, Mercado Libre, sitio propio",
    "Productos top: Women Multi+, Inositol, Adaptógenos, T-STO",
    "Parte del portafolio de Nest Brands",
  ];
  const missing = [
    "0 transmisiones en vivo",
    "0 revenue por live commerce",
    "100% dependiente de video y afiliados",
    "El canal de mayor conversión de TikTok Shop no está activado",
  ];
...
function SlideProof({ active }: { active: boolean }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      callout:
        "Vende Inositol, Magnesio y Omega 3 — las mismas categorías que Vital Botanics.",
    },
    {
      name: "Bloom",
  ...
  return (
    <SlideWrap active={active} wide>
      ...
      <p className="anim mt-8 text-center font-[family-name:var(--font-outfit)] text-base text-white">
        Bloom genera $272K/mes con 42K seguidores. En TikTok Lives, lo que importa
        <br />
        no es el tamaño de la audiencia — es la ejecución, el producto, y la consistencia.
      </p>
    </SlideWrap>
  );
}
...
function SlideStrategy({ active }: { active: boolean }) {
  const blocks = [
    {
      title: "Producto héroe: Women Multi+",
      body: "Tu bestseller en Mercado Libre con reviews excepcionales. Multivitamínico mujer con colágeno, biotina, ácido fólico — ideal para contenido educativo en live. Productos complementarios: DChiro-Myo Inositol (salud hormonal) y Biotin+Collagen (belleza). Un kit natural de cross-sell durante cada sesión.",
    },
    {
      title: "Formato: Educativo + Flash Deals",
      body: "Sesiones de 2 horas donde la host educa sobre bienestar femenino, salud hormonal, y adaptógenos. Cada 20 minutos, oferta flash exclusiva para viewers. B Life usa este mismo formato y genera $40-55K por sesión. El catálogo profundo de Vital Botanics (40+ productos) permite variedad entre sesiones sin repetir.",
    },
    {
      title: "Calendario: 3× por semana",
      body: "Martes y Jueves 8:00 PM · Domingo 3:00 PM. Los horarios de máximo tráfico para wellness en México. B Life transmite por las mañanas — Vital Botanics puede dominar el horario nocturno sin competencia directa en su categoría.",
    },
  ];
...
function SlideInvestment({ active }: { active: boolean }) {
  ...
  const scenarios = [
    { label: "Escenario Conservador", perSession: "$10K", total: "$120K/mes" },
  ...
  return (
    <SlideWrap active={active} wide>
      ...
      <p className="anim mt-8 font-[family-name:var(--font-outfit)] text-[15px] font-light leading-relaxed text-text">
        Bloom genera $272K/mes con lives y un catálogo más pequeño. Al 15% de ese rendimiento, Vital Botanics generaría <span className="font-semibold text-magenta">~$41K/mes</span> — cubriendo la inversión desde el primer mes.
      </p>
...
export default function VitalBotanicsDeck() {
